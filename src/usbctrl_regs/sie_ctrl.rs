...
pub type START_TRANS_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, SIE_CTRL_SPEC, bool, O>;
...
pub type STOP_TRANS_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, SIE_CTRL_SPEC, bool, O>;
...
pub type RESUME_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, SIE_CTRL_SPEC, bool, O>;
...
pub type RESET_BUS_W<'a, const O: u8> = crate::BitWriter0C<'a, u32, SIE_CTRL_SPEC, bool, O>;
